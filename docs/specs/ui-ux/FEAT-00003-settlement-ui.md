...
> **Registry IDs:** FEAT-00003, FEAT-00007, FEAT-00008
> **Owner:** /ba | **Version:** 1.0 | **Date:** 2026-03-25
> **Depends on:** `REQ-billing-settlement.md` (REQ-00004, 00006, 00011, 00013, 00016)

---

## 1. FEAT-00003: QR Settlement Screen (CRITICAL)
...
### 1.3 API cần gọi
- `GET /api/sessions/:id/calculate` (API-00011) → Lấy bill result
...
## 2. FEAT-00007: Copy Amount & Quick Actions
...
## 3. FEAT-00008: Host Price Update Form (ORDERED)
...
1. **Sửa ship/voucher:** `PUT /api/sessions/:id` (API-00021) — body: `{ shippingFee, discountType, discountValue }`
2. **Sửa giá từng món:** `PUT /api/order-items/:id` (API-00014) — body: `{ price }`
3. **Preview bill:** `GET /api/sessions/:id/calculate` (API-00011)
