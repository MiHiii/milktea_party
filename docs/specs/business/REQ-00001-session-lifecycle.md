...
> **Registry IDs:** REQ-001, REQ-009, REQ-010, REQ-014, REQ-019
...
## 2. REQ-001: Session State Machine (6 trạng thái)
...
## 3. REQ-009: Session Password Protection
...
- **API:** `POST /api/sessions/slug/:slug/verify` → đã đăng ký (API-009) ✅
...
## 4. REQ-010: Multi-Join (Slug / UUID / URL)
...
## 5. REQ-014: Session CANCELLED State
...
## 6. REQ-019: Session Expiry / Auto-cleanup
