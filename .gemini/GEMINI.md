...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | **/ba** | Business Analyst | `.gemini/agents/AGENT_BA.md` | `.gemini/skills/SKILL_BA.md` | `REQ-xxxxx` & `api_spec.md` |
...
2. **BA (`/ba`)**: Tiếp nhận yêu cầu, viết đặc tả nghiệp vụ chi tiết vào `api_spec.md` và công thức vào `milktea-logic.md`.
...
```plaintext
├── docs/
│   ├── api_overview.md       # [BA] - API overview & common logic
│   ├── milktea-logic.md      # [BA] - Business logic & formulas
│   ├── api_spec.md           # [BA] - API contract & endpoints
...
8. **Design Before Build**: Features lớn (≥3 tables hoặc ≥2 layers) phải có TDD từ `/architect` trước khi code.
9. **5-Digit IDs**: 100% Task/Test/Bug IDs phải dùng format 5 chữ số zero-padded (ví dụ: FEAT-00005).
